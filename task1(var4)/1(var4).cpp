...
public:
    ...
    {
        cout << "Point constructor(newX, newY)\n";
    }
...
public:
    ...
    {
        cout << "Ellipse deafult constructor\n";
    }

    //Конструктор, який приймає координати для центру еліпса, та його піввісь
    Ellipse(double newX, double newY, double newA, double newB) : Point(newX, newY), a(newA), b(newB)
    {
        cout << "Ellipse constructor(newX, newY, newA, newB)\n";
    }
...
public:
    ...
    //Конструктор, який приймає координати для центру кола, та його радіус
    Circle(double newX, double newY, double radius) : Ellipse(newX, newY, radius, radius)
    {
        cout << "Circle constructor(newX, newYm, radius)\n";
    }
